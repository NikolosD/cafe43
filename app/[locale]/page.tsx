...
export default function LanguageSplashPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-white via-red-50/50 to-red-100 flex flex-col items-center justify-center p-6 pb-24 text-black relative overflow-hidden">
